...
export interface StorageContext {
    // Config operations
    getConfig: () => Promise<SchemaFlowConfig | undefined>;
    updateConfig: (config: Partial<SchemaFlowConfig>) => Promise<void>;
